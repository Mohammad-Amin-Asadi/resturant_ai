...
class OpenAI(AIEngine):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, call, cfg):
        ...
        self.intro = self.cfg.get("welcome_message", "OPENAI_WELCOME_MESSAGE", " سلامُ درود بر شما، باتاکسیِ وی آی پی تماس گرفته اید، لطفا جهت رِزِرو تاکسی نام خود را بفرمایید.")
